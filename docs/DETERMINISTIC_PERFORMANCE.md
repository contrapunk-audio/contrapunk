...
This contract does **not** promise sample-identical floating-point audio, identical OS/device delivery jitter, or recovery from unbounded real-time stalls.
...
- Held-note configuration replay is ordered by pitch, then source channel.
