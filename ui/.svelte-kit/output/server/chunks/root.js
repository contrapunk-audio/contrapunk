import { H as HYDRATION_ERROR, C as COMMENT_NODE, a as HYDRATION_END, b as HYDRATION_START, c as HYDRATION_START_ELSE, r as run_all, B as BOUNDARY_EFFECT, R as REACTION_RAN, E as ERROR_VALUE, d as EFFECT, f as CONNECTED, g as CLEAN, M as MAYBE_DIRTY, D as DIRTY, h as DERIVED, W as WAS_MARKED, I as INERT, i as BLOCK_EFFECT, U as UNINITIALIZED, j as deferred, k as BRANCH_EFFECT, l as ROOT_EFFECT, m as RENDER_EFFECT, o as MANAGED_EFFECT, p as HEAD_EFFECT, q as DESTROYED, A as ASYNC, s as includes, t as HYDRATION_START_FAILED, u as EFFECT_TRANSPARENT, v as EFFECT_PRESERVED, S as STALE_REACTION, n as noop, w as EAGER_EFFECT, x as STATE_SYMBOL, y as object_prototype, z as array_prototype, F as get_descriptor, G as get_prototype_of, J as is_array, K as is_extensible, L as USER_EFFECT, N as REACTION_IS_UPDATING, O as index_of, P as define_property, Q as array_from, T as is_passive_event, V as LEGACY_PROPS, X as render, Y as derived } from "./index.js";
...
function schedule_effect(signal) {
  ...
  while (effect.parent !== null) {
    effect = effect.parent;
    var flags2 = effect.f;
    if (is_flushing && effect === active_effect && (flags2 & BLOCK_EFFECT) !== 0 && (flags2 & HEAD_EFFECT) === 0 && (flags2 & REACTION_RAN) !== 0) {
      return;
    }
