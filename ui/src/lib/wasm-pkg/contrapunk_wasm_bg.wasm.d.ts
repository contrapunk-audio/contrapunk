...
export const engine_last_port_map: (a: number, b: number) => void;
...
export const engine_note_off_channel: (a: number, b: number, c: number, d: number) => void;
export const engine_note_on: (a: number, b: number, c: number) => void;
export const engine_note_on_channel: (a: number, b: number, c: number, d: number) => void;
...
export const companionwasm_counterpoint_state: (a: number, b: number) => void;
...
export const companionwasm_on_cc: (a: number, b: number, c: number, d: number, e: number) => void;
...
export const companionwasm_phrase_state: (a: number, b: number) => void;
...
export const companionwasm_set_phrase_gap: (a: number, b: number, c: number) => void;
...
export const elixiraudio_note_on_slide: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
...
export const elixiraudio_set_expression: (a: number, b: number) => void;
export const elixiraudio_set_master_gain: (a: number, b: number) => void;
export const elixiraudio_set_mod_wheel: (a: number, b: number) => void;
export const elixiraudio_set_pitch_bend_cents: (a: number, b: number) => void;
export const elixiraudio_set_role_gain: (a: number, b: number, c: number) => void;
export const elixiraudio_set_role_parameter: (a: number, b: number, c: number, d: number) => void;
export const elixiraudio_set_sustain: (a: number, b: number) => void;
export const elixiraudio_slide_curves_ptr: (a: number) => number;
export const elixiraudio_slide_durations_ptr: (a: number) => number;
export const elixiraudio_slide_frequencies_ptr: (a: number) => number;
export const elixiraudio_slide_progresses_ptr: (a: number) => number;
export const elixiraudio_slide_slots_ptr: (a: number) => number;
export const elixiraudio_slide_snapshot_count: (a: number) => number;
export const elixiraudio_slide_targets_ptr: (a: number) => number;
export const elixiraudio_slide_voice_ids_ptr: (a: number) => number;
